...
**Zero-context agent?** Läs **ZERO_CONTEXT_LOAD.md** först — den ger exakt läsordning och gate.
...
ZERO_CONTEXT_LOAD.md    ← Läsordning för zero-context agent — läs först om ingen kontext
...
.cursor/bridge/         ← Claude–Codex samarbete: skriv till claude_plan.md, läs codex_plan.md
