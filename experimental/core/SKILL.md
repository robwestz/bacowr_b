...
```
Output: articles/job_{job_number:02d}.md
```
...
**Gate:** 11/11 pass. See references/qa-template.md for script format. Save QA to `articles/qa_{job_number:02d}.md`.
...
for job in jobs:
    ...
    # Track progress in articles/batch_progress.json
```
